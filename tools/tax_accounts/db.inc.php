...
if (!$SESS_DBH = mysql_connect($SESS_DBHOST, $SESS_DBUSER, '')) {
...
*/
include_once "{$vg_tax_dir_site_root}db.inc.php";

// DB 테이블명 정의
$vg_tax_db_tables = array();
$vg_tax_db_tables[buyer_list] = "VG_TAX_buyer_list";				// 기업 기본 정보
$vg_tax_db_tables[tax_list] = "VG_TAX_tax_list";								// 발급 계산서 목록
?>