...
$value = "회원입력상자{$GLOBALS[DV][dv]}{$article_item_user}{$GLOBALS[DV][dv]}{$input_box_type}{$GLOBALS[DV][dv]}{$default_pp}{$GLOBALS[DV][dv]}{$input_items}{$GLOBALS[DV][dv]}{$divider}{$GLOBALS[DV][dv]}{$item_index}{$GLOBALS[DV][dv]}";
